...
(function () {
  ...
  const STRINGS = {
    en: {
      ...
      'p2.cta.note': '<em>My own ring.</em> Lacrimosa is not for sale.<br class="br-lg">A piece in its spirit can be commissioned.',
    ...
    es: {
      ...
      'p2.cta.note': '<em>Mi propio anillo.</em> Lacrimosa no está en venta.<br class="br-lg">Se puede encargar una pieza en su espíritu.',
