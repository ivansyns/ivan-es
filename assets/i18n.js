...
(function () {
  ...
  const STRINGS = {
    en: {
      ...
      'work.wip.h': 'Web work',
      'work.wip.p': 'This page is being rebuilt. In the meantime, tell me what you need and I will answer directly.',
    ...
    es: {
      ...
      'work.wip.h': 'Trabajo web',
      'work.wip.p': 'Esta página se está rehaciendo. Mientras tanto, cuéntame qué necesitas y te contesto directamente.',
