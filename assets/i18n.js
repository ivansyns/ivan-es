...
(function () {
  ...
  const STRINGS = {
    en: {
      ...
      'work.a.p': 'Hand-written HTML, CSS and JavaScript. No page builder, no template, no build step to rot.',
      ...
      'p2.hero.sub': 'Natural Diamond · 0.90 ct · Pear · IGI',
      'p2.status': "Maker's own · not for sale",
      'p2.scroll.cue': 'scroll',
      'p2.story.eyebrow': 'Story',
      'p2.story.line1': 'The tear, alchemized — the weight that was once a burden turned out to be more valuable than gold.',
      'p2.story.line2': 'Sand-coloured, its form after the Eye of the Sahara, where beauty is found in the harshest conditions. Named <em>Lacrimosa</em> for the requiem Mozart never finished — the silence left behind after the music reached its purest harmony.',
      ...
      'p2.cert.openDownload': 'Open / download',
      'p2.cta.numero': 'No. 002',
      'p2.cta.eyebrow': 'A note on this piece',
      'p2.cta.note': '<em>My own ring.</em> Lacrimosa was made for me and is not for sale. A piece in its spirit can be commissioned.',
    ...
    es: {
      ...
      'work.a.p': 'HTML, CSS y JavaScript escritos a mano. Sin maquetador, sin plantilla, sin build que se pudra.',
      ...
      'p2.hero.title.aria': 'Lacrimosa',
      'p2.hero.sub': 'Diamante Natural · 0,90 ct · Pera · IGI',
      ...
      'p2.cert.meta': 'IGI · 0,90 ct',
      'p2.cert.openDownload': 'Abrir / descargar',
      'p2.cta.numero': 'Nº 002',
      'p2.cta.eyebrow': 'Una nota sobre esta pieza',
      'p2.cta.note': '<em>Mi propio anillo.</em> Lacrimosa se hizo para mí y no está en venta. Se puede encargar una pieza en su espíritu.',
